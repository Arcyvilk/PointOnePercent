...
router.get('/user/create/:username/:hash', user.create)
router.post('/user/profilechange/:username', user.profilechange)
router.get('/admin/ban/:username', user.ban)
router.get('/admin/blog/add', user.addBlog)
router.get('/admin/blog/edit', user.editBlog)
router.get('/admin/blog/delete', user.deleteBlog)
